...
console.log('AverageRating for historyOfEverything is:' + historyOfEverything.getAverageRating());
// ---------------------------------------------- Start Movie ---------------------------------------------
const speed = new Movie('Jan de Bont', 'Speed', 116, 'Chandler Bing');

speed.toggleCheckOutStatus();

console.log('The speed is check out: ' + speed.isCheckedOut);
...
console.log('AverageRating for speed is: '+ speed.getAverageRating());
//------------------------------------------------Start Cd ----------------------------------------------------
...
console.log('AverageRating for stateOfTrance is: '+ stateOfTrance.getAverageRating())
